...
import { Text, View, Button, TextInput, SafeAreaView, ScrollView, TouchableOpacity } from "react-native";
...
export default function App() {
  return (
    <NavigationContainer>
      <Drawer.Navigator>
        <Drawer.Screen name="Profile Screen" component={FirstItem} />
        <Drawer.Screen name="Message Screen" component={TabNavigation} />
      </Drawer.Navigator>
    </NavigationContainer>
  );
}